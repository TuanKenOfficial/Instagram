...
public class AdapterChat extends RecyclerView.Adapter<AdapterChat.HolderChats>{
    ...
    public AdapterChat(Context context, ArrayList<Chats> mChat) {
    ...
    @NonNull
    @Override
    public AdapterChat.HolderChats onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterChat.HolderChats holder, int position) {
        ...
        String callVideos = chat.getCallVideos();
